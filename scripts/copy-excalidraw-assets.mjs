// Copies Excalidraw's self-hosted fonts + stylesheet into the browser app's
// served static root so the .excalidraw editor never fetches fonts from a CDN
// (offline-safe / CSP-safe). Wired into apps/browser `bundle` because Theia's
...
const target = join(repoRoot, 'apps/browser/lib/frontend/excalidraw-assets');
