...
// `parseWikiLinks` moved to the narrative-knowledge package in TASK-022 WP-0;
// the integration case at the bottom of this file deliberately keeps using it
// from there, so the seam between the relocated parser and the navigation
// helpers that stayed is exercised rather than assumed.
